...
<body>
	...
	<article>
		...
		<center><img alt="设计类图" src="resource/abstractfac.png" style="height:100%;width:90%"></center>
		<blockquote>
		说明：<br><br>
		<font size="4" >ChartDrawer:客户类，选择具体的图表工厂类型绘制图表<br><br>
		ChartFac:抽象工厂类，定义图表产品族的生产行为<br><br>
		CrystalChartFac,FlatChartFac:具体工厂类，继承ChartFac，生产具体样式的的产品<br><br>
		Pie,Line,Bar:抽象产品类，共同构成产品族<br><br>
